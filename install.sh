...
echo ""
echo "Option 2: Built-in web server (Not recommended for CloudShell)"
echo "   • The tool can start a local web server after generating reports"
echo "   • This only works within the CloudShell environment"
echo "   • External access is not possible due to CloudShell limitations"
echo "   • Use Option 1 instead for better experience"
echo ""
echo "💡 Tip: The standalone server handles all CORS issues automatically"
echo ""
